...
| --- | --- | --- | --- | --- |
| A / `single` | 100.67 | 100.67 上单臂 `1-4` | `left_wrist,left,middle` | `127.0.0.1:6001` |
| B / `right` | 100.67 | 100.67 通过 `15` 在 131 启动 right `1-4` | `middle,right,right_wrist` | 默认 `192.168.1.131:6001` |
| C / `dual` | 100.67 | 100.67 本地 left `1-4`，SSH 启动 131 right `1-4` | 全部配置相机 | 左 `127.0.0.1:6002`，右默认 `192.168.1.131:6001` |
...
- Xpra 只连 `muka@192.168.100.67`；右臂 SSH 固定为 `pnp@192.168.1.131`。
- B/C 必须从 100.67 发起，不在 131 再启动一套 Hub。
