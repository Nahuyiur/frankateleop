...
RIGHT_TELEOP_CONFIG_PORT_OVERRIDE="${BI_ARM_RIGHT_TELEOP_CONFIG_PORT:-${RIGHT_TELEOP_CONFIG_PORT:-}}"
...
Environment:
  ...
  BI_ARM_RIGHT_TELEOP_CONFIG_PORT=
...
start_local_script() {
    ...
    (
        ...
        export RIGHT_TELEOP_CONFIG_PORT="$RIGHT_TELEOP_CONFIG_PORT_OVERRIDE"
...
export RIGHT_TELEOP_CONFIG_PORT=$(q "$RIGHT_TELEOP_CONFIG_PORT_OVERRIDE")
