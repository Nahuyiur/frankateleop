...
def parse_args():
    ...
    parser.add_argument(
        "--camera-names",
        default="",
        help="Comma-separated camera names to preview and record. Empty means all configured cameras.",
    )
...
def main() -> int:
    ...
    app.setApplicationName("Franka Dual GUI Capture" if args.mode == "dual" else "Franka GUI Capture")
