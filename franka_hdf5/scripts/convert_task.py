...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Convert a franka_capture task directory to HDF5 episodes.")
    parser.add_argument("task_dir", help="Task directory, e.g. /home/pnp/Desktop/franka_record_data/pick_block.")
    parser.add_argument("--output-root", default=None, help="Output HDF5 dataset root.")
    parser.add_argument("--task-description", default=None, help="Task text stored in HDF5 metadata.")
...
def main() -> None:
    ...
    print(f"Output HDF5 dataset: {output_root}")
